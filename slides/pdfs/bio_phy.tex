...
\label{sec:orgc35416b}

\begin{frame}[label={sec:org7da4246}]{Protein Design}
\begin{center}
\Large\textbf{Engineer proteins for desirable properties}
\end{center}
\end{frame}

\begin{frame}[label={sec:org6885165}]{Experimental Approaches}
\begin{itemize}
...
\end{frame}
\begin{frame}[label={sec:org4a764b2}]{Computational Protein Design}
\begin{itemize}
...
\begin{frame}[label={sec:orge9fad5c}]{Why Computational Design is Desirable}
\begin{itemize}
...
\begin{frame}[label={sec:orgcf7e9c8}]{The Problem: Physics-Based Approach}
...
\begin{frame}[label={sec:org1251b36}]{Protein Design Principles}
...
\begin{frame}[label={sec:org0f0dd15}]{Usually not realistic}
\begin{center}
...
\begin{frame}[label={sec:org44489df}]{Usual timescale for the folding process}
\begin{center}
...
\begin{frame}[label={sec:org81aea67}]{Exploring Protein Conformations}
...
\begin{frame}[label={sec:orge8d6ba8}]{Navigating the Protein Sequence Space}
...
\begin{frame}[label={sec:org99b9003}]{Understanding the Unfolded State}
...
\label{sec:orga614dbd}

\begin{frame}[label={sec:orgc305658}]{Test case: redesigning the PDZ fold}
...
\begin{frame}[label={sec:org456cae0}]{Sampling sequences}
...
\begin{frame}[label={sec:org52dea7d}]{MD simulations}
...
\begin{frame}[label={sec:org787f97d}]{Computational enzyme design}
\begin{center}
\Large\textbf{Design for the binding or catalysis}
\end{center}
\end{frame}

\begin{frame}[label={sec:org340c631}]{The problem definition}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\begin{frame}[label={sec:org43c0d0e}]{Designing a strong binder}
\begin{columns}
\begin{column}{0.6\columnwidth}
...
\begin{frame}[label={sec:orgbe10310}]{Designing catalysts: the transition state}
\begin{center}
...
\label{sec:orge557c2f}

\begin{frame}[label={sec:org62265c0}]{Conclusion: Computational Protein Design - A Paradigm Shift}

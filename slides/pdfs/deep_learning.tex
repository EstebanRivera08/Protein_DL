...
\label{sec:orgaccb087}
\begin{frame}[label={sec:orga701860}]{Why Deep Learning?}
\begin{columns}
...
\begin{frame}[label={sec:orgcc428a4}]{Application of DL in biology}
\begin{center}
...
\begin{frame}[label={sec:org8d68e35}]{What are the DL techniques used in protein sequence generation?}
\begin{center}
\Large \textbf{Generative models to sample sequences}
\end{center}
\end{frame}
\begin{frame}[label={sec:org35d3cc9}]{Deep Generative Models}
\begin{itemize}
...
\begin{frame}[label={sec:orgf2e4154}]{Variational Autoencoders (VAEs) in Protein Design}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org97d1118}]{Variational autoencoder framework [Ding \emph{et al}, 2020, Nat. Com.]}
\begin{center}
...
\begin{frame}[label={sec:orga8f7525}]{Use a structure predictor to deduce sequences}
\begin{center}
...
\begin{frame}[label={sec:org3bf0ce0}]{AlphaFold structure prediction}
\begin{center}
\includegraphics[width=.9\linewidth]{./img/AlphaFold_2.png}
\end{center}
...
\begin{frame}[label={sec:org9e25b3f}]{AlphaFold: inverting the prediction}
...
(J. Jumper \emph{et al}, 2020, Nature)
\end{frame}
\begin{frame}[label={sec:orged23755}]{AlphaFold: inverting the prediction}
...
\begin{frame}[label={sec:org3cc5d15}]{AlphaFold: inverting the prediction}
...
\end{frame}
\begin{frame}[label={sec:org9f15376}]{Reverting AlphaFold}
...
\begin{frame}[label={sec:org6b021a6}]{Graph neural network}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgfe7af76}]{Graph neural network}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgb35c8f5}]{Graph neural network}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgdb9d391}]{Graph neural network}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgee81abd}]{Graph neural network}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org433dcd5}]{Graph neural network}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org6788450}]{Graph neural network}
\begin{columns}
...
\begin{frame}[label={sec:orgd269e86}]{Graph neural network}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orge0d67a6}]{Graph neural network}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
